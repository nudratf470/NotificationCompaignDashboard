  ...
  return (
    <Row className="top-bar align-items-center mx-0">
      ...
      <Col className="d-flex align-items-center gap-3" xs="auto">
        ...
        <h3 className="mb-0 TemplateTopbar-heading">
      ...
      <Col  className="d-flex justify-content-center align-items-center gap-2">
        ...
        <span className="changes-saved-text">Changes Saved</span>
        ...
        <button className="action-btn undo-btn">
          ...
          >
            ...
            />
            <path
              d="M17.5 14.1665C17.5 12.1774 16.7098 10.2697 15.3033 8.8632C13.8968 7.45668 11.9891 6.6665 10 6.6665C8.15427 6.66838 6.37404 7.3508 5 8.58317L2.5 10.8332"
              stroke="#C1C1C1"
              stroke-width="1.25"
              stroke-linecap="round"
              stroke-linejoin="round"
        ...
        <button className="action-btn redo-btn">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
          ...
          >
            ...
            />
            <path
              d="M2.5 14.1665C2.5 12.1774 3.29018 10.2697 4.6967 8.8632C6.10322 7.45668 8.01088 6.6665 10 6.6665C11.8457 6.66838 13.626 7.3508 15 8.58317L17.5 10.8332"
              stroke="#C1C1C1"
              stroke-width="1.25"
              stroke-linecap="round"
              stroke-linejoin="round"
