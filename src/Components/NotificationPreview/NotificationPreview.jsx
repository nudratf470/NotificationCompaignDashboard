      ...
      <div className="appointment-updated mt-md-5">
        ...
        <div className="appoinment d-flex gap-3">
          ...
          <div class="appointmentschedule ">
            <h4 className="p-0 m-0 d-flex justify-content-between align-items-center"> Appointment Updated <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
