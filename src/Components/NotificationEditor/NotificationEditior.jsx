  ...
  return (
    <div className="appointmentContainer d-flex align-items-center justify-content-center">
      <div className="notification-editor">
        ...
        {/* Upload Section */}
        <div className={`editor-section ${collapsed.upload ? 'collapsed' : ''}`}>
          <div className="section-header">
            {!collapsed.upload ? (
              ...
              <span className="section-collapsed-title">Upload</span>
            )}
            <button
        ...
        {/* Title Section */}
        <div className={`editor-section ${collapsed.title ? 'collapsed' : ''}`}>
          <div className="section-header">
            {!collapsed.title ? (
              <h2 className="card-title">Appointment Updated!</h2>
            ) : (
              <span className="section-collapsed-title">Appointment Updated!</span>
            )}
            <button
              className="minimize-icon"
        ...
        {/* Description Section */}
        <div className={`editor-section ${collapsed.description ? 'collapsed' : ''}`}>
          <div className="section-header">
            {!collapsed.description ? (
              ...
              <span className="section-collapsed-title">Your appointment has been...</span>
            )}
            <button
              className="minimize-icon"
        ...
        {/* Timing Section */}
        <div className={`editor-section ${collapsed.timing ? 'collapsed' : ''}`}>
          <div className="section-header timing-section-header">
            {!collapsed.timing ? (
              ...
              <span className="section-collapsed-title">Timing: Jan 15, 2025</span>
            )}

            <button
              className="minimize-icon"
              onClick={() => toggleSection('timing')}
              aria-label="Toggle timing section"
            >
              <MinimizeIcon />
            </button>
          </div>
