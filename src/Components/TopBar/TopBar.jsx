...
const TopBar = ({
  ...
  if (isMobile) {
    return <MobileTopBar icons={icons} />
  }
  ...
  return (
    <Row className="top-bar align-items-center mx-0 px-2">
      ...
      <Col
        className={`topbar-left d-flex align-items-center gap-0 gap-sm-2 p-0 ${
          showToggle ? "col-auto" : ""
        }`}
      >
      ...
      {showToggle && (
        <Col className="d-flex justify-content-center align-items-center gap-2">
          <div
            ...
            style={{ marginRight: !showUndoRedo && !showChangesSaved ? "150px" : "0" }}
          >
      ...
      <Col xs="auto" className="d-flex align-items-center gap-2 p-0 pe-2">
        {showAddButton && (
          ...
          <div className="setting-icon d-flex align-items-center justify-content-center">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path
                ...
                stroke="#404145" strokeLinecap="round" strokeLinejoin="round"
              />
              <path
